// Example: Enhanced Services Page with CMS Integration
// This replaces the hardcoded content in /app/services/page.tsx
...
export default async function EnhancedServicesPage() {
  ...
  const coreServices = services.filter((s: Service) => s.category === 'core')
  const specialtyServices = services.filter((s: Service) => s.category === 'specialty')
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="grid lg:grid-cols-2 gap-0 min-h-[50vh] items-center">
                ...
                <div className="flex flex-col justify-center space-y-8 lg:pr-16">
                    ...
                    <div className="max-w-lg relative pl-2">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-lg text-gray-600 font-light leading-relaxed">
                          {services.length} integrated service offerings working together to transform your organization through thoughtful design.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-8 pt-4">
                    {[
                      { value: services.length.toString(), label: "Service Offerings" },
                      { value: featuredProducts.length.toString(), label: "Featured Products" },
                      { value: verticalMarkets.length.toString(), label: "Market Specializations" }
                    ].map((stat, index) => (
                  ...
                  <div className="absolute inset-0 flex items-end p-12 bg-gradient-to-t from-black/60 to-transparent">
                    <div className="space-y-4">
                      ...
                      <div className="text-white text-xl md:text-2xl font-light leading-tight">
                        {services.length} Service Areas<br />Working as One
                      </div>
              ...
              <div className="lg:col-span-8 lg:col-start-1">
                <div className="relative">
                  ...
                  <h2 className="text-4xl md:text-5xl lg:text-6xl font-extralight leading-[0.9] tracking-[-0.03em] text-gray-900">
                    <span className="block transform hover:translate-x-1 transition-transform duration-300">{coreServices.length} integrated</span>
      ...
      {/* Dynamic Specialty Services Grid */}
              ...
              {specialtyServices.map((service: Service) => (
                <div key={service._id} className="group">
                  <div className="aspect-[4/3] relative overflow-hidden mb-6">
                    {service.heroImage ? (
                      <img 
                        src={urlFor(service.heroImage).width(400).height(300).url()} 
                        alt={service.title}
                        className="w-full h-full object-cover"
                      />
                    ) : (
                      <div className="w-full h-full bg-gradient-to-br from-orange-900 via-orange-700 to-orange-900"></div>
                    )}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
                    <div className="absolute bottom-6 left-6 text-white">
                      <div className="text-sm uppercase tracking-[0.2em] font-medium mb-2">{service.title}</div>
                  ...
                  <div className="space-y-4">
                    ...
                    <CTAButton href={`/services/${service.slug.current}`} variant="outline" size="sm">
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="max-w-4xl pt-8 space-y-6">
                      <p className="text-xl md:text-2xl text-gray-700 font-light leading-[1.5] tracking-wide">
                        Deep expertise across {verticalMarkets.length} diverse industries, with specialized knowledge for unique requirements and challenges.
                      </p>
